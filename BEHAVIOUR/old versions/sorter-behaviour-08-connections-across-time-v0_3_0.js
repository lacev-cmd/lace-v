// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 08  Connections Across Time  v0.3.0
...
const BehaviourConnectionsAcrossTime = {
  ...
  recurrenceRx: /\b(
    same pattern|same cycle|same loop|same situation|same thing again|
    I keep doing this|I keep ending up here|I keep coming back to this|
    I always|I never|every time|it always happens|it always ends|
    it always goes the same|history repeating|round and round|
    I have been here before|I have done this before|I recognise this|
    I know this pattern|I see this pattern|this is familiar|
    the pattern is|the cycle is|the loop is|the trigger is|
    I find myself here again|I am back to|I have returned to|
    I said this before|I wrote this before|I have been in this place before
  )\b/ix,
  ...
  triggerRx: /\b(
    when I am|when things get|when the pressure|when it gets hard|
    when I am tired|when I am stressed|when I am alone|when I am isolated|
    when I am with|when I see|when I go to|when I am near|
    after a difficult|after a conflict|after a bad|after a hard|
    when money is|when I have no|when I feel|when I start to feel|
    when things fall|when it all|when everything|when I cannot|
    the trigger is|what sets it off|what starts it|what breaks it|
    conditions that|situations that|the circumstances that|
    it happens when|it breaks when|it starts when|it begins when
  )\b/ix,
  ...
  positiveRecurrenceRx: /\b(
    I always manage|I always find a way|I always come back|I always recover|
    even when|despite everything|no matter what|through it all|
    I have done this before and I did it|I have been here before and I came through|
    I am resilient|I bounce back|I keep going|I do not give up|
    this is something I can do|this is something I have done|
    I have proven|I have shown|I have demonstrated|
    my strength|my resilience|what I am capable of|
    something that works for me|something that has always helped|
    something I rely on|a skill I have|a tool that works
  )\b/ix,
  ...
  dismissalRx: /\b(
    that is not the same|that is different|that is not connected|
    those are not related|that does not apply|that is not relevant|
    I would not say that|I do not see that|I do not think that is|
    it is not a pattern|it is just a coincidence|it just happened|
    nothing to do with|unrelated|different situation|different context|
    I disagree with that|that is not accurate|that is not what happened
  )\b/ix,
  ...
  testCases: [
    ...
    {
      id:       'CAT-02',
      input:    '"I know this pattern. I always end up here when I am isolated."',
      expected: 'Self-named recurrence — strongest connection signal. Trigger identified: isolation.',
    },
    {
      id:       'CAT-03',
    ...
    {
      id:       'CAT-05',
      input:    'Same conditions appear before breakdown in three separate periods.',
      expected: 'Trigger pattern surfaced explicitly.',
    },
    {
      id:       'CAT-06',
