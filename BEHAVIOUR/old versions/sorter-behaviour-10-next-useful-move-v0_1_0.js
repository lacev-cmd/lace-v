// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 10  Next Useful Move  v0.1.0
...
const BehaviourNextUsefulMove = {
  ...
  testCases: [
    {
      id:       'NUM-01',
      input:    'No direction stated.',
      expected: 'Move: state the direction clearly.',
    },
    {
      id:       'NUM-02',
      input:    'Correction marks family as primary.',
      expected: 'Move: add more specific material about family or contact.',
    },
    {
      id:       'NUM-03',
      input:    'Contradiction present.',
      expected: 'Move: describe the conditions where each side is true.',
    },
    {
      id:       'NUM-04',
      input:    'Skill breaking under load.',
      expected: 'Move: describe one specific breakdown moment.',
    },
    {
      id:       'NUM-05',
      input:    'No gaps, pressure active.',
      expected: 'Move: describe what would reduce the main pressure.',
    },
  ],
