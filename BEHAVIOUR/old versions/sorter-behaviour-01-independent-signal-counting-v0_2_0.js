...
const BehaviourIndependentSignalCounting = {
  ...
  negationRx: /\b(no longer|not a problem|not anymore|used to|I used to|that was|in the past|not now|resolved|it is fine now|no issue|not an issue|I do not have|I don't have|haven't had|have not had)\b/i,
  ...
  countingRules: {
    ...
    lengthThreshold:
      'entry length above 100 characters used as a proxy for substance. Known approximation — a short entry can be decisive and a long one can be padding. Use as a tiebreaker only, not a primary signal.',
    recencyWeight:
