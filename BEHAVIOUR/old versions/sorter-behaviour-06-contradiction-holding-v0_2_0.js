// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 06  Contradiction Holding  v0.2.0
...
const BehaviourContradictionHolding = {
  ...
  statedChangeRx: /\b(
    I have changed|I am different now|I am a different person|things have changed|
    I have turned a corner|I have moved on|I have grown|I have learned|
    I am not that person anymore|that is not who I am|I have left that behind|
    I am better now|I am in a better place|things are better|
    I have improved|I have made progress|I have come a long way|
    I am doing well|I am doing better|things are going well|
    I have got my head straight|I have sorted myself out|I have got it together|
    I would not do that now|I know better now|I handle things differently|
    the old me|the person I was|back then I was different
  )\b/ix,
  ...
  samePatternRx: /\b(
    same thing|same mistake|same pattern|same cycle|same loop|same situation|
    same again|back to it|back to where|back at the start|back to square one|
    I did it again|it happened again|there I was again|same as before|
    same old|history repeating|round and round|going in circles|
    I keep doing|I always do|I never learn|I end up|every time I|
    it always ends the same|it always goes the same way|
    nothing has really changed|not much has changed|I am still doing|
    the pattern continues|the cycle continues|I fell back into
  )\b/ix,
  ...
  statedGoalRx: /\b(
    my goal is|my aim is|my priority is|what I want is|what matters to me|
    I want to|I am working toward|I am trying to achieve|I am focused on|
    family is everything|family comes first|my children|my kids come first|
    work is my priority|my career matters|the most important thing is|
    I care most about|what I am doing this for|the reason I|
    I am doing this for|this is all for|I want to get back to|
    I want to rebuild|I want to prove|I want to show|
    my future|what I am aiming for|where I want to be|
    health is my priority|recovery is my priority|staying clean is everything
  )\b/ix,
  ...
  statedCapabilityRx: /\b(
    I can handle|I am able to|I am capable of|I manage|I know how to|
    I am good at|I am strong|I am resilient|I bounce back|I cope well|
    I keep my cool|I stay calm|I do not react|I walk away|
    I have the skills|I have what it takes|I am ready|I can do this|
    I have done it before|I know I can|I have the strength|
    I am disciplined|I am consistent|I am reliable|I follow through
  )\b/ix,
  ...
  capabilityBreakdownRx: /\b(
    I lost it|I snapped|I reacted|I blew up|I could not hold it|
    I gave in|I caved|I went back|I slipped|I relapsed|I broke|
    I could not|I was not able to|I failed to|I did not manage to|
    I fell apart|I crumbled|I collapsed|I could not cope|
    it all fell apart|I was not ready|I could not handle it|
    I thought I could but|I told myself I could but|I said I would but
  )\b/ix,
  ...
  positiveFrameRx: /\b(
    things are good|things are going well|I am doing well|everything is fine|
    I am in a good place|life is good|I am happy|I am positive|
    things have improved|no major issues|no concerns|no problems|
    all good|nothing to worry about|on the right track|making progress|
    I feel strong|I feel confident|I feel ready
  )\b/ix,
  ...
  negativeDetailRx: /\b(
    but then|except|however|although|despite that|having said that|
    but actually|but really|if I am honest|to be honest|the truth is|
    it is not all|it is not quite|not everything is|not all is|
    there is one thing|there is something|I should mention|I need to say|
    there was an incident|something happened|it went wrong|it did not go well|
    I struggled with|I had a hard time|it was difficult when|it got hard when
  )\b/ix,
  ...
  selfContradictionRx: /\b(
    I want to but I do not|I say one thing and do another|
    I know I should but I|I tell myself but then|
    I am trying but I keep|I mean to but I never|
    part of me wants to and part of me does not|
    I feel two ways about|I am torn between|I am conflicted|
    on one hand and on the other|both things are true|
    I believe it but I also|I want it but I also|
    I feel it but I also do not|I both want and do not want
  )\b/ix,
  ...
  testCases: [
    {
      id:       'CTH-01',
      input:    '"I have changed." and "Same mistake again."',
      expected: 'Stated change and same pattern both visible. Tension named, not resolved.',
    },
    {
      id:       'CTH-02',
      input:    '"Family is everything." No contact language across entries.',
      expected: 'Goal and behaviour tension named.',
    },
    {
      id:       'CTH-03',
      input:    '"Things are going well." Followed by incident description.',
      expected: 'Positive frame vs negative detail tension named.',
    },
    {
      id:       'CTH-04',
      input:    '"I keep my cool." and "I lost it when they pushed."',
      expected: 'Stated capability vs breakdown tension named.',
    },
    {
      id:       'CTH-05',
      input:    '"I want to but I keep not doing it."',
      expected: 'Self-contradiction within entry detected.',
    },
    {
      id:       'CTH-06',
    ...
    {
      id:       'CTH-07',
      input:    '"Ready for release." Incident in same period.',
      expected: 'Readiness claim vs incident tension named.',
    },
  ],
