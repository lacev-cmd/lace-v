// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 02  Baseline vs Live Material  v0.2.0
...
const BehaviourBaselineVsLiveMaterial = {
  ...
  resolutionRx: /\b(
    sorted|resolved|dealt with|handled|addressed|fixed|closed|finished|
    no longer an issue|no longer a problem|that is behind me|moved past|
    I got through it|I came through it|it is done|it is over|
    I sorted it|I resolved it|I dealt with it|I fixed it|I closed it|
    it worked out|it came good|it came right|
    I found a way through|I found a solution|I found an answer|
    no longer relevant|no longer applies|that chapter is closed
  )\b/ix,
  ...
  emergenceRx: /\b(
    something new|a new issue|a new problem|a new pressure|
    something has come up|something has happened|something has changed|
    I did not mention|I did not say|I forgot to include|I left out|
    there is something else|there is more|there is another thing|
    since then|after I wrote that|after the baseline|since I started|
    something I did not realise|I did not know at the time|
    I have realised since|I have noticed since|I have become aware of
  )\b/ix,
  ...
  directionRx: /\b(
    my goal|my aim|my direction|what I want|what I am working toward|
    I want to|I am trying to achieve|I am working toward|I am focused on|
    my plan|my intention|what I intend|where I want to be|
    what I am doing this for|the reason I am here|why I am doing this|
    what I want back|what I want to rebuild|what I want to prove|
    my future|the future I want|what matters to me|what I care about|
    I want to get to|I want to reach|I am heading toward
  )\b/ix,
  ...
  capabilityClaimRx: /\b(
    I am good at|I am capable of|I can handle|I manage well|I know how to|
    I am able to|I have the skill|I have experience|I have done it before|
    I am disciplined|I am reliable|I follow through|I keep commitments|
    I stay calm|I do not react|I walk away|I handle pressure|
    I have support|I have people around me|I have a network|
    I have a routine|I have structure|I have a plan
  )\b/ix,
  ...
  driftRx: /\b(
    actually|in fact|to be honest|if I am honest|the truth is|
    it is more like|it is actually|it is not quite|it is different from|
    that was not quite right|I overstated|I understated|
    I was not quite honest about|I did not fully explain|
    it is more complicated than|it is more serious than|
    I realise now|I see now|I understand now|looking back|on reflection|
    it was not as|it was more|I was not as|I was more
  )\b/ix,
  ...
  testCases: [
    {
      ...
      expected: 'Cannot distinguish resolved, avoided, or not written about. State the ambiguity.',
    },
    {
      id:       'BLM-02',
    ...
    },
    {
      ...
      expected: 'Drift or contradiction — baseline framing does not match entry material.',
    },
    {
      id:       'BLM-05',
      input:    '"If I am honest, that was not quite right when I wrote it."',
      expected: 'Baseline drift — person reframing earlier account.',
    },
    {
      id:       'BLM-06',
      input:    'User correction: "that was old, not current."',
