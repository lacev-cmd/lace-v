// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 05  Load-Sensitive Capability  v0.2.1
...
const BehaviourLoadSensitiveCapability = {
  ...
  defaultLoadSignals: [
    ...
    {
      key: 'pain',
      rx: /\b(pain|painful|hurting|in agony|agony|flare|flare up|bad day physically|chronic pain|pain levels|my condition|my health|physical pain|in a lot of pain|unable to move|physically difficult|body struggling|my back|my joints|my illness|unwell|sick|not well physically)\b/i,
    },
    {
      key: 'fatigue',
    ...
    {
      key: 'fear',
      rx: /\b(scared|afraid|frightened|anxious|anxiety|terrified|terror|dread|dreading|fearful|I fear|I am scared|I am afraid|I am terrified|I am dreading|panic|panicking|panic attack|heart racing|I froze|I shut down from fear|the fear of|the thought of|what if|worst case)\b/i,
    },
    {
      key: 'shame',
    ...
    {
      key: 'institutional',
      rx: /\b(hearing|adjudication|review|assessment|inspection|board|panel|they decided|the decision came|waiting for the decision|court|tribunal|review date|appeal|formal process|official|the system|the organisation|bureaucracy|red tape|waiting on them)\b/i,
    },
    {
      key: 'financial',
    ...
    {
      key: 'relational',
      rx: /\b(relationship broke|they left|split up|separated|divorce|falling out|estranged|no contact with family|family issues|problems at home|domestic|the relationship|my partner|my ex|they are not speaking to me|I am not speaking to them|family conflict|family pressure|difficult at home)\b/i,
    },
    {
      key: 'mental_health',
  ...
  heldUnderLoadRx: /\b(even though|despite|although|in spite of|regardless|anyway|still|I did it anyway|I kept going anyway|I showed up anyway|I held it anyway|I did not feel like it but|I was exhausted but|I was scared but|I was under pressure but|even when it was hard|even in that moment|I pushed through|I held it together|I kept my head|I stayed calm|I did not react|I did not engage|I walked away|I removed myself|I maintained|I kept the boundary|I kept the routine|I kept going|I held on|I did not give in|I did not give up|I stayed with it|under pressure I still|even when they pushed I|despite everything I)\b/i,
