// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 08  Connections Across Time  v0.3.1
...
const BehaviourConnectionsAcrossTime = {
  ...
  triggerRx: /\b(when I am|when things get|when the pressure|when it gets hard|when I am tired|when I am stressed|when I am alone|when I am isolated|when I am with|when I see|when I go to|when I am near|after a difficult|after a conflict|after a bad|after a hard|when money is|when I have no|when I feel|when I start to feel|when things fall|when it all|when everything|when I cannot|the trigger is|what sets it off|what starts it|what breaks it|conditions that|situations that|the circumstances that|it happens when|it breaks when|it starts when|it begins when)\b/i,
