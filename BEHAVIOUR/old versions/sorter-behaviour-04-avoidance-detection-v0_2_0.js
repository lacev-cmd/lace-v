// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 04  Avoidance Detection  v0.2.0
...
const BehaviourAvoidanceDetection = {
  ...
  lexicalAvoidanceRx: /\b(
    I have been avoiding|I keep avoiding|I am avoiding|I have avoided|
    I keep putting it off|I keep putting off|I have been putting off|I put it off|
    I keep meaning to|I keep saying I will|I keep telling myself|
    I have not done it|I have not started|I have not gone back|I have not followed through|
    I have not dealt with|I have not faced|I have not addressed|I have not tackled|
    I cannot bring myself|I cannot make myself|I cannot face|I cannot start|
    I know I should|I know I need to|I know I have to|
    I am not ready|I do not feel ready|I am not there yet|
    I have been putting it to the back|I have been ignoring|I have been burying|
    I keep delaying|I keep postponing|I keep deferring|
    I have been dragging my feet|I have been stalling|I have been hesitating|
    I am scared to|I am afraid to|I am worried about|I dread|
    I do not want to deal with|I do not want to face|I do not want to think about|
    I have been burying my head|I have been hiding from|I have been running from
  )\b/ix,
  ...
  indirectAvoidanceRx: /\b(
    maybe I will|maybe next week|maybe when|maybe if|perhaps I should|perhaps when|
    I might|I might try|I might look into|I might get around to|
    at some point|eventually|one day|when the time is right|when things settle|
    when I am ready|when I have the energy|when things calm down|when it gets easier|
    I am not sure when|I have not decided when|I have not figured out when|
    I will see|I will think about it|I will consider it|I will look into it|
    it is on my list|it is something I want to do|it is something I need to look at|
    I have been thinking about it|I am still thinking|I am still deciding|
    I am not sure where to start|I do not know how to start|I am figuring out how|
    I am not sure it will help|I am not sure it is worth it|I am not sure I am ready
  )\b/ix,
  ...
  deflectionRx: /\b(
    anyway|but anyway|moving on|changing the subject|on a different note|
    it does not matter|it is not important|it is not a big deal|it is fine really|
    I do not want to dwell|I do not want to go into it|I would rather not talk about|
    let us not focus on|that is not the main thing|that is not what matters|
    there are more important things|other things are more pressing|
    it is what it is|nothing I can do|what will be will be|no point worrying|
    I try not to think about it|I try not to dwell|I push it to the back|
    I distract myself|I keep busy so I do not have to|I stay busy to avoid|
    it is easier not to think about|I cope by not thinking about
  )\b/ix,
  ...
  knowingWithoutDoingRx: /\b(
    I know what I need to do|I know what the problem is|I know what I should do|
    I understand the issue|I understand why|I get why|I see why|I know why|
    I am aware|I know it is|I recognise|I can see that|I understand that|
    I know I need to change|I know things need to change|I know something has to change|
    I have figured out|I have worked out|I have realised|I have understood|
    I know the pattern|I see the pattern|I understand the cycle|
    I know it is not working|I can see it is not working|I understand it is not helping|
    it is clear to me|it is obvious to me|I can see clearly|I understand fully
  )\b/ix,
  ...
  defaultActionRx: /\b(
    I called|I rang|I phoned|I texted|I messaged|I emailed|I wrote to|I reached out|
    I attended|I showed up|I went to|I turned up|I kept the appointment|
    I completed|I finished|I followed through|I saw it through|
    I submitted|I filed|I sent|I handed in|I delivered|
    I applied|I registered|I signed up|I booked|I scheduled|I arranged|
    I paid|I cleared|I settled|
    I spoke to|I talked to|I told|I had the conversation|I brought it up|I raised it|
    I reported|I contacted|I notified|I flagged|
    I asked for help|I used the support|I called the helpline|
    I held the boundary|I said no|I kept my distance|
    I returned to|I picked it up again|I restarted|I tried again|
    I named it|I admitted|I was honest about|I told the truth about|
    I made the decision|I committed to|I chose|
    I reduced|I cut down|I stopped|I stayed clean|
    I repaired|I apologised|I addressed it|
    I interrupted the pattern|I did something different
  )\b/ix,
  ...
  testCases: [
    ...
    {
      id:       'AVD-02',
      input:    '"Maybe I will call next week when things settle."',
      expected: 'Indirect avoidance — deferral and condition language.',
    },
    {
      id:       'AVD-03',
      input:    'Financial pressure in three entries. No action language in any.',
      expected: 'Structural avoidance — pressure without response.',
    },
    {
      id:       'AVD-04',
      input:    '"I know what the problem is. I understand the pattern."',
      expected: 'Knowing without doing — awareness without action.',
    },
    {
      id:       'AVD-05',
      input:    '"Anyway, things are fine. I do not want to dwell on it."',
      expected: 'Deflection detected — topic redirected.',
    },
    {
      id:       'AVD-06',
      input:    '"I am waiting for the housing decision. Nothing I can do until it comes."',
      expected: 'External constraint — not avoidance. Behaviour 15 handles this.',
    },
    {
      id:       'AVD-07',
      input:    'Delay caused by medical advice.',
      expected: 'Not avoidance — not-avoidance list applies.',
    },
    {
      id:       'AVD-08',
      input:    '"I did not go for two days." Correction: do not treat as avoidance.',
      expected: 'Suppressed or downgraded by correction.',
    },
  ],
