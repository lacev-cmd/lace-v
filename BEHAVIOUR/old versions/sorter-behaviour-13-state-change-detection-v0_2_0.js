// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 13  State Change Detection  v0.2.0
...
const BehaviourStateChangeDetection = {
  ...
  changeAssertionRx: /\b(
    I have changed|things have changed|I am different|something has shifted|
    I feel different|I think differently|I act differently|
    I am in a different place|things are different now|it is different now|
    I have moved on|I have grown|I have learned|I have developed|
    a shift has happened|something has changed in me|I can feel the difference|
    I notice the difference|I can see the change|I believe I have changed
  )\b/ix,
  ...
  behaviouralEvidenceRx: /\b(
    I did not react the way I used to|I handled it differently|I responded differently|
    I would have done X before but now I|the old me would have|
    I caught myself|I noticed and chose differently|I interrupted the pattern|
    for the first time I|I have not done it since|I have not been back|
    it has not triggered|the conditions were there but I did not|
    I tested it and it held|it came up and I dealt with it differently|
    I am doing something I could not do before|I managed something I could not manage
  )\b/ix,
  ...
  moodShiftRx: /\b(
    I feel better|I feel worse|I feel different|my mood has changed|
    I feel more positive|I feel more negative|I feel lighter|I feel heavier|
    I feel hopeful|I feel hopeless|I feel optimistic|I feel pessimistic|
    things feel different|it feels different|something feels different|
    emotionally I am|mentally I am|I am in a better headspace|I am in a worse headspace
  )\b/ix,
  ...
  testCases: [
    { id: 'SCD-01', input: '"I am a different person now." No behavioural evidence.',                expected: 'Asserted change only.' },
    { id: 'SCD-02', input: 'Financial pressure at baseline. Three recent entries show none and a payment arrangement.',  expected: 'Evidenced state change.' },
    { id: 'SCD-03', input: '"I felt better this week." No change in described behaviour.',           expected: 'Mood shift. Not state change.' },
    { id: 'SCD-04', input: '"I handled it differently. I caught myself and walked away."',           expected: 'Behavioural evidence of change.' },
    { id: 'SCD-05', input: 'Pattern triggered previously. Same conditions present now — no trigger.',expected: 'Possible pattern break — emerging change.' },
  ],
};
