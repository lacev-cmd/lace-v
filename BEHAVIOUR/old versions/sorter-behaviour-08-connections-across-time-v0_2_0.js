...
const BehaviourConnectionsAcrossTime = {
  ...
  minimumSeparationDays: 14,  // Override per deployment. Minimum gap in calendar days
                               // between two appearances to qualify as a connection.

  detectionRules: {
    minimumSeparation:
      'Use minimumSeparationDays. Two appearances closer together than this threshold do not qualify as a time-separated connection.',
