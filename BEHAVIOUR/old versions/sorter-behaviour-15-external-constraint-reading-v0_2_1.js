// ══════════════════════════════════════════════════════════
// SORTER BEHAVIOUR — 15  External Constraint Reading  v0.2.1
...
const BehaviourExternalConstraintReading = {
  ...
  partialBlockRx: /\b(I cannot do X but I can|blocked on one thing but not on|I am stuck on that part but|that aspect is blocked but other things are not|while I wait for|in the meantime I can|while that is being decided I could|that is out of my hands but|I cannot control that but I can control|one door is closed but|that channel is blocked but)\b/i,
