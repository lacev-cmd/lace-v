// ══════════════════════════════════════════════════════════
// SORTER GUIDE — Mental Health  v0.2.0
...
//   — open-gap-discipline.absenceRules: functionalFirst rule
//     added to make functional capacity vs symptom distinction
//     explicit at the gap-reading layer.
...
const GuideMentalHealth = {
  ...
  contradictions: [
    {
      a:    /\b(I am okay|I am managing|I am fine|I am getting on|I am coping|I am doing alright|I am okay really|it is not that bad)\b/i,
      b:    /\b(I did not get up|I stayed in bed|I could not function|I did not eat|I have not left|I have not slept|I broke down|I cannot concentrate|I have stopped|everything is an effort)\b/i,
      text: 'A stated sense of coping and described functional difficulty both appear. Presenting as managing and functioning at reduced capacity are not contradictory in this sector — they frequently coexist. The functional description is the more reliable read. The map holds both without resolving either.',
    },
    {
  ...
  steer: {
    ...
    'open-gap-discipline': {
      ...
      absenceRules: {
        ...
        functionalFirst:
          'Read functional capacity before symptom description. What the person can and cannot do is the primary signal. Symptom names without functional consequence are secondary. A person describing severe symptoms while maintaining function is in a different position from a person describing the same symptoms with functional collapse — the map must distinguish them.',
        crisisFirst:
    ...
    'confidence-calibration': {
      sectorNote:
        'Mental health maps are frequently partial because shame and stigma reduce honest disclosure. Presenting-as-coping language is common. Absence of named difficulty does not mean absence of difficulty. Confidence should reflect what is written, not what is implied. A map where all entries describe functioning well but contain no functional specifics should not exceed partial confidence.',
    },
    ...
    'avoidance-detection': {
      notAvoidance: [
        'Not attending an appointment because physical illness made it impossible.',
        'Taking a planned break from therapy agreed with the clinician.',
        'Crisis plan pause agreed with care team.',
        'Reduced contact with support during a period of stability — not all withdrawal is disengagement.',
        'Not naming symptoms in detail because the person does not have the language yet.',
        'Presenting positively to others while describing difficulty privately — code-switching is not avoidance.',
        'A day of low function without an identifiable cause — symptom variability is not avoidance.',
        'Choosing not to take a specific coping strategy that has not worked — this is adjustment, not avoidance.',
        'Medication side effects causing a genuine barrier to engagement — this is a constraint, not avoidance.',
        'Delayed help-seeking where stigma or past bad experience with services is the named barrier.',
      ],
    },
