// ══════════════════════════════════════════════════════════
// SORTER GUIDE — Addiction Recovery  v0.2.0
...
//     Distinguishes genuine struggle (craving, physical state,
//     shame load) from concealment of use.
//     Without this distinction the behaviour cannot read this
//     sector correctly — silence about use and silence about
//     difficulty look identical without the calibration.
...
const GuideAddictionRecovery = {
  ...
  skills: [
    ...
    },
    {
      ...
      loadSensitive:    false,
      isStructureSkill: false,
      works:            'Reading the relapse event for what it reveals — trigger, circumstance, gap in support — rather than treating it as proof that recovery is impossible.',
      breaks:           'Shame converts the relapse into a verdict rather than a signal. The person stops analysing what happened and instead focuses on what it means about them. The information is lost.',
    },
  ],
  ...
  contradictions: [
    {
      a:    /\b(I am doing well|recovery is going well|I am in a good place|things are better|I feel strong|I am managing|I have this)\b/i,
      b:    /\b(I missed the meeting|I have not called|I stopped going|I have not been|I cancelled|I have not spoken to|I dropped out|I am not going)\b/i,
  ...
  steer: {
    ...
    'avoidance-detection': {
      notAvoidance: [
        'Missing a meeting because of physical illness or a genuine scheduling conflict — not all missed meetings are disengagement.',
        'Reducing meeting frequency at a clinician or sponsor\'s recommendation during a stable period.',
        'Not naming use in an entry because of shame — the absence is a signal, not confirmed concealment. Surface the gap, do not assert use.',
        'Craving without use — naming the craving is engagement, not avoidance.',
        'Describing near-miss encounters with triggers without using — this is movement, not avoidance.',
        'A pause in programme engagement following a life crisis — grief, bereavement, major disruption — where the crisis itself is named.',
        'Slow progress — the pace of recovery varies. Do not read steady but slow movement as stuck.',
        'Not yet naming all triggers — trigger awareness develops over time. Partial trigger knowledge is not avoidance.',
        'Physical withdrawal symptoms preventing engagement — this is a constraint, not avoidance.',
        'Choosing not to attend a specific group that has not been helpful, when actively engaged elsewhere.',
      ],
      avoidanceSignals: [
        'Use minimising language — framing use as "not counting" or "controlled" — is the primary avoidance signal in this sector.',
        'Shame-driven silence — no account of use, no description of craving, no named difficulty, but high-risk proximity visible in material.',
        'Programme disengagement without named reason, especially combined with increasing isolation.',
        'Confidence spike language appearing alongside described ongoing difficulty — the stated position and the described situation do not match.',
      ],
    },
